// --- GESTION DES CHAMPS DE TRI ---

// Sélection de tous les éléments de classe ".select-header"
const selectHeaders = document.querySelectorAll(".select-header");

// Boucle sur chaque élément ".select-header" pour ajouter un écouteur d'événements "click"
selectHeaders.forEach((header) => {
  header.addEventListener("click", () => {
    ...
    const up = selectContainer.querySelector(".up");
    const down = selectContainer.querySelector(".down");

    // Toggle la classe ".show" de l'élément ".select-search-container"
...
class App {
  constructor() {
    ...
    // emplacement parent pour l'injection des recettes
    this.recipesApi = new RecipesApi("../data/recipes.json");
    // fetch de la liste des recettes
